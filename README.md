## clearpath_robot (humble) - 1.3.10-1

The packages in the `clearpath_robot` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_robot -r humble -t humble` on `Wed, 09 Sep 2026 17:53:40 -0000`
...
## clearpath_robot (jazzy) - 2.9.7-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Wed, 09 Sep 2026 17:50:54 -0000`
...
## clearpath_robot (jazzy) - 2.9.6-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Thu, 13 Aug 2026 15:07:56 -0000`
...
## clearpath_robot (jazzy) - 2.9.5-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Fri, 07 Aug 2026 17:00:16 -0000`
...
## clearpath_robot (humble) - 1.3.9-1

The packages in the `clearpath_robot` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_robot -t humble -r humble` on `Fri, 17 Jul 2026 17:01:01 -0000`
...
## clearpath_robot (jazzy) - 2.9.4-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Fri, 17 Jul 2026 16:44:23 -0000`
...
## clearpath_robot (jazzy) - 2.9.3-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Fri, 22 May 2026 03:28:58 -0000`
...
## clearpath_robot (humble) - 1.3.8-1

The packages in the `clearpath_robot` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_robot -r humble -t humble` on `Wed, 15 Apr 2026 01:22:34 -0000`
...
## clearpath_robot (jazzy) - 2.9.2-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Wed, 15 Apr 2026 01:16:20 -0000`
...
## clearpath_robot (jazzy) - 2.9.1-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Thu, 12 Feb 2026 03:25:52 -0000`
...
## clearpath_robot (jazzy) - 2.9.0-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Thu, 12 Feb 2026 03:19:57 -0000`
...
## clearpath_robot (jazzy) - 2.8.6-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Tue, 20 Jan 2026 19:26:20 -0000`
...
## clearpath_robot (humble) - 1.3.7-1

The packages in the `clearpath_robot` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_robot -r humble -t humble` on `Tue, 20 Jan 2026 14:50:15 -0000`
...
## clearpath_robot (jazzy) - 2.8.5-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Mon, 19 Jan 2026 16:47:48 -0000`
...
## clearpath_robot (humble) - 1.3.6-1

The packages in the `clearpath_robot` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_robot -r humble -t humble` on `Thu, 20 Nov 2025 18:38:22 -0000`
...
## clearpath_robot (jazzy) - 2.8.4-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Thu, 13 Nov 2025 18:02:34 -0000`
...
## clearpath_robot (jazzy) - 2.8.3-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Mon, 10 Nov 2025 15:19:40 -0000`
...
## clearpath_robot (jazzy) - 2.8.2-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Tue, 28 Oct 2025 18:28:52 -0000`
...
## clearpath_robot (jazzy) - 2.8.1-1

The packages in the `clearpath_robot` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_robot -r jazzy -t jazzy` on `Thu, 23 Oct 2025 21:33:39 -0000`
...
The packages in the `clearpath_robot` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_robot --new-track -r humble -t humble` on `Fri, 21 Jul 2023 01:37:19 -0000`
